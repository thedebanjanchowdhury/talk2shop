...
import * as _langchain_core_messages7 from "@langchain/core/messages";
...
declare function createAgentExecutor({
  ...
  steps: Step[];
  input: string;
  chatHistory?: BaseMessage<_langchain_core_messages7.MessageStructure, _langchain_core_messages7.MessageType>[] | undefined;
}, {
  agentOutcome?: AgentAction | AgentFinish | undefined;
  ...
  chatHistory?: BaseChannel<BaseMessage<_langchain_core_messages7.MessageStructure, _langchain_core_messages7.MessageType>[] | undefined, BaseMessage<_langchain_core_messages7.MessageStructure, _langchain_core_messages7.MessageType>[] | undefined, unknown> | undefined;
}, {
  agentOutcome?: BaseChannel<AgentAction | AgentFinish | undefined, AgentAction | AgentFinish | undefined, unknown> | undefined;
  steps: BaseChannel<Step[], Step[], unknown>;
  input: BaseChannel<string, string, unknown>;
